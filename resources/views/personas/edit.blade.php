                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nombre de la persona"
                                        name="nombreP" value="{{ $personas->nombreP }}">
                                </div>
                                <div class="form-group">
                                    <label>Apellido de la persona</label>
                                    <input type="text" class="form-control" placeholder="Apellido de la persona"
                                        name="apellidoP" value="{{ $personas->apellidoP }}">
                                </div>
                                <div class="form-group">
                                    <label>Edad de la persona</label>
                                    <input type="number" class="form-control" placeholder="Edad de la persona"
                                        name="edadP" value="{{ $personas->edadP }}">
                                </div>
                                <div class="form-group">
                                    <label>Cedula de la persona</label>
                                    <input type="text" class="form-control" placeholder="Cedula de la persona"
                                        name="cedulaP" value="{{ $personas->cedulaP }}">
                                </div>
                                <div>
